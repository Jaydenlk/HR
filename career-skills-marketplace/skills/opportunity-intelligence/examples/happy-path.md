...
```json
{
  ...
  "skill_version": "1.0.0",
  "summary": "字节跳动推荐系统后端岗位综合评分74分，建议谨慎投递。候选人技术栈匹配度良好，但推荐系统领域经验缺失是主要差距。薪资竞争力强，大小周为已知风险。",
  "confidence": "high",
  "evidence_used": [
    { "source": "jd_analysis", "content": "职位要求3年以上Java/Go后端，薪资30k-50k×16薪" },
    { "source": "match_diagnosis", "content": "整体匹配分78，主要差距为推荐系统经验" },
...
- 综合分74 = 匹配78×0.4 + 市场分85×0.35 + (100-20)×0.25 ≈ 31.2 + 29.75 + 20 = 74
- 市场分基于字节头部品牌+16薪结构，估算85
- 风险分20（一个yellow信号约20分）
- `apply_with_caution` 而非 `strong_apply` 主要因领域经验差距
