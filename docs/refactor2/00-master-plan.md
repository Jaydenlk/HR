...
| 序 | 任务 | 文档 | 体量 | 依赖 |
|----|------|------|------|------|
| 1 | T1 导航四模块重组+删页 | `T1-nav-cleanup.md` | 小 | 无 |
| 2 | T6 博查统一搜索服务 | `T6-bocha-search.md` | 小中 | T1(行业趋势模块先删) |
| 3 | T5 投递追踪二级页 | `T5-application-detail.md` | 中 | T6(公司背景实体) |
| 4 | T2 月刊校招情报 | `T2-recruit-intel.md` | 中大 | 无(可与 T4 并行) |
| 5 | T4 技术债+防护加固 | `T4-hardening.md` | 中 | 无(可与 T2 并行) |
