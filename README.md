...
Coach 是一个面向应届生和早期技术岗求职者的 AI 求职操作系统。它不只是工具集合，而是一个**懂你**的教练——读过你的简历、知道你投了哪些公司、看过你的面试记录，然后基于这些**真实数据**给出个性化建议。
...
- **CoachContextService** — 每次对话自动聚合简历/投递/机会/任务/诊断/面经 6 个模块的数据
