...
Coach 是一个面向应届生和早期技术岗求职者的 AI 求职操作系统。它基于**真实用户数据**给出个性化建议——读取简历、投递记录、机会评估、诊断历史、任务进度、面经情报、薪资参考、面试复盘、模拟面试和求职信共 10 个核心求职数据模块。
...
| **问 Coach** | AI 对话教练 | 读取 10 个核心求职数据模块的个性化建议（Evidence Layer） |
...
- **EvidenceService** — 聚合简历/诊断/投递/机会/任务/面经情报/薪资参考/面试复盘/模拟面试/求职信 10 个核心求职数据模块的结构化证据
