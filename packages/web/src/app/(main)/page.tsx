      ...
      <section>
        ...
        >
          ...
          {diagnoses.length > 0 && (
            <a
              href="/diagnoses"
              style={{ fontSize: '13px', color: 'var(--color-brand)', textDecoration: 'none', fontWeight: 500 }}
            >
              查看全部
            </a>
          )}
        ...
        {loadingDiag ? (
          ...
          >
            ...
            />
            <p style={{ fontSize: '14px', fontWeight: 500, color: 'var(--color-ink-2)', marginBottom: '6px' }}>
              还没有诊断记录
            </p>
