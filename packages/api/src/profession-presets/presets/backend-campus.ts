...
export const backendCampus: ProfessionPreset = {
  ...
  rewriteGuidance: '改写只能基于简历已有内容重组/量化/补技术证据链(把“做了个管理系统”改写为带并发/缓存/数据规模的表述)。严禁虚构项目、数字或经历;缺数字用 [具体数字] 占位并在 reason 说明“建议补充真实数据”;简历无某经历(如大厂实习/开源)输出“建议补充 X”而非编造;original 必须是简历原文一字不差。',
