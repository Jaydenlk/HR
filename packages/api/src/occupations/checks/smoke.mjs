 ...
 * 不依赖那条目录下的任何其它代码)
 *
 * 用途:验证 dim1/dim3/edges 三个校验脚本能在新 9 层骨架下正常运行,并输出符合预期
 ...
 *
 * 预期结果:
 *  SAMPLE_PASS: dim1=pass, dim3=pass
...
const SAMPLE_PASS = {
  ...
  skeleton: {
    ...
    development: {
      promotion_path: ['结构设计师(0-3年,用 PKPM/YJK 做标准层配筋)', '专业负责人(3-6年,统筹单体项目 SAP2000/ETABS 整体计算与出图)', '结构总工/技术总监(6-10年以上,把关全院 GB50010、GB50011 技术标准与超限审查)'],
      ceiling: '多数人的天花板在专业负责人一级;能走到结构总工的比例很低,且高度依赖设计院平台资质(甲级院)和持续中标的复杂项目类型。',
      lateral_moves: ['转岗施工单位技术负责人(懂 AutoCAD 图纸与设计规范)', '转岗审图机构审图工程师', '转岗造价工程师'],
    },
    trend: {
