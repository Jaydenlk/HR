...
4. 技能分类：technical 为技术技能（编程语言、框架、工具等），soft 为软技能，languages 为语言能力，certifications 为证书。语言能力与证书必须连同原文中的分数或等级一并保留（如"英语六级（480分）""雅思 6.5""CET-4 580""CPA 已过 4 门"），不得只留证书名而丢弃分数/等级/进度
